...
const ct = (r) => new rt(typeof r == "string" ? r : r + "", void 0, V), dt = (r, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: pt, defineProperty: $t, getOwnPropertyDescriptor: _t, getOwnPropertyNames: ft, getOwnPropertySymbols: mt, getPrototypeOf: yt } = Object, f = globalThis, F = f.trustedTypes, gt = F ? F.emptyScript : "", j = f.reactiveElementPolyfillSupport, w = (r, t) => r, R = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? gt : null;
      break;
  ...
  return e;
} }, q = (r, t) => !pt(r, t), G = { attribute: !0, type: String, converter: R, reflect: !1, useDefault: !1, hasChanged: q };
...
v.elementStyles = [], v.shadowRootOptions = { mode: "open" }, v[w("elementProperties")] = /* @__PURE__ */ new Map(), v[w("finalized")] = /* @__PURE__ */ new Map(), j == null || j({ ReactiveElement: v }), (f.reactiveElementVersions ?? (f.reactiveElementVersions = [])).push("2.1.0");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const P = globalThis, k = P.trustedTypes, Q = k ? k.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, nt = "$lit$", _ = `lit$${Math.random().toFixed(9).slice(2)}$`, ot = "?" + _, At = `<${ot}>`, A = document, O = () => A.createComment(""), U = (r) => r === null || typeof r != "object" && typeof r != "function", W = Array.isArray, vt = (r) => W(r) || typeof (r == null ? void 0 : r[Symbol.iterator]) == "function", z = `[ 	
\f\r]`, C = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, X = /-->/g, Y = />/g, m = RegExp(`>|${z}(?:([^\\s"'>=/]+)(${z}*=${z}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), tt = /'/g, et = /"/g, ht = /^(?:script|style|textarea|title)$/i, bt = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), Et = bt(1), b = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), st = /* @__PURE__ */ new WeakMap(), y = A.createTreeWalker(A, 129);
function at(r, t) {
...
const St = (r, t) => {
  ...
  for (let a = 0; a < e; a++) {
    const h = r[a];
    let c, u, l = -1, p = 0;
    for (; p < h.length && (n.lastIndex = p, u = n.exec(h), u !== null); ) p = n.lastIndex, n === C ? u[1] === "!--" ? n = X : u[1] !== void 0 ? n = Y : u[2] !== void 0 ? (ht.test(u[2]) && (i = RegExp("</" + u[2], "g")), n = m) : u[3] !== void 0 && (n = m) : n === m ? u[0] === ">" ? (n = i ?? C, l = -1) : u[1] === void 0 ? l = -2 : (l = n.lastIndex - u[2].length, c = u[1], n = u[3] === void 0 ? m : u[3] === '"' ? et : tt) : n === et || n === tt ? n = m : n === X || n === Y ? n = C : (n = m, i = void 0);
    const $ = n === m && r[a + 1].startsWith("/>") ? " " : "";
    o += n === C ? h + At : l >= 0 ? (s.push(c), h.slice(0, l) + nt + h.slice(l) + _ + $) : h + _ + (l === -2 ? a : $);
  }
    ...
    for (; (i = y.nextNode()) !== null && h.length < a; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const l of i.getAttributeNames()) if (l.endsWith(nt)) {
          ...
          h.push({ type: 1, index: o, name: T[2], strings: $, ctor: T[1] === "." ? wt : T[1] === "?" ? Pt : T[1] === "@" ? xt : D }), i.removeAttribute(l);
        ...
        if (ht.test(i.tagName)) {
          ...
          if (p > 0) {
            ...
            for (let $ = 0; $ < p; $++) i.append(l[$], O()), y.nextNode(), h.push({ type: 2, index: ++o });
            i.append(l[p], O());
          }
        }
...
class H {
  ...
  _$AI(t, e = this) {
    t = E(this, t, e), U(t) ? t === d || t == null || t === "" ? (this._$AH !== d && this._$AR(), this._$AH = d) : t !== this._$AH && t !== b && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : vt(t) ? this.k(t) : this._(t);
  }
  O(t) {
...
L == null || L(M, H), (P.litHtmlVersions ?? (P.litHtmlVersions = [])).push("3.3.0");
const Ut = (r, t, e) => {
...
var it;
x._$litElement$ = !0, x.finalized = !0, (it = g.litElementHydrateSupport) == null || it.call(g, { LitElement: x });
const I = g.litElementPolyfillSupport;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ht = { attribute: !0, type: String, converter: R, reflect: !1, hasChanged: q }, Tt = (r = Ht, t, e) => {
...
let S = class extends x {
  constructor() {
    super(...arguments), this.startValue = 0, this._count = 0;
  }
  connectedCallback() {
    super.connectedCallback(), this._count = this.startValue;
  }
  _increment() {
    this._count++, this._dispatchCountChange();
  }
  _decrement() {
    this._count--, this._dispatchCountChange();
  }
  _dispatchCountChange() {
    const t = new CustomEvent("count-changed", {
...
S.styles = dt`
  ...
  `;
J([
  lt({ type: Number, attribute: "start-value" })
], S.prototype, "startValue", 2);
J([
  Nt()
